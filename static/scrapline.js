...
import { NadoDapp, $, notify, confirmingLabel, disp, _m, renderTopScores, share, base , installModes } from "./nadodapp.js?v=acba3d6b";
import { DuelGame } from "./duelgame.js?v=3ed4c6b7";
import * as E from "./scrapline-engine.js?v=c9428a07";
import { ART } from "./scrapline-art.js?v=5dc6e120";
import { prand, Practice } from "./practice.js?v=d44e512f";   // practice-vs-computer + solo persistence
