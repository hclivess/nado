...
import { NadoDapp, rawToNado, nadoToRaw, randId, _m, $, base, gate, canPay, orderCards, chainResultAlg, blocksToTime, wireWallet, stickyInputs, renderWallet, renderScore, scoreBump, scoreSort, alertBar, notify, confirmingLabel, loadQR, resolveAliases, disp, share, shareInvite , installModes , playModes} from "./nadodapp.js?v=77a0d4df";
import { BankedGame } from "./bankedgame.js?v=20df019f";
import { Practice } from "./practice.js?v=1e947bde";      // free in-browser practice (play chips, no chain)

const CID = "891bbd32f1409aa435a23e43fe28ea5b";
...
const boardFrom = (sto) => bg.scoreboard(sto, (g, stake) =>
  _m(sto, "gw")[g] ? Number(returnRaw(stake, _m(sto, "gm")[g] || 1)) - stake : -stake);
