...
import { NadoDapp, rawToNado, nadoToRaw, randId, _m, $, base, gate, canPay, orderCards, alertBar, notify, blocksToTime, lsLoad, lsSave, wireWallet, stickyInputs, renderWallet, loadQR, drawQR, resolveAliases, disp, shareInvite, confirmingLabel, esc } from "./nadodapp.js?v=68319609";
import * as G from "./pets-genes.js?v=3fa721d8";
