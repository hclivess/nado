...
import { NadoDapp, rawToNado, nadoToRaw, randId, randSecret, algHashn, ALG_P, _m, $, base, gate, canPay, alertBar, inviteGate, orderCards, blocksToTime, lsLoad as load, lsSave as save, wireWallet, stickyInputs, renderWallet, renderScore, notify, okBar, scoreBump, scoreSort, loadQR, resolveAliases, disp, share, shareInvite , installModes , playModes} from "./nadodapp.js?v=5ff32141";
import { BankedGame } from "./bankedgame.js?v=059e530d";   // the ONE banked-table reader — hold'em overlays its street phases
import { Practice } from "./practice.js?v=1b0a48d4";       // free in-browser practice (play chips, no chain)

const CID = "baf1f33c2e136c094c63fa245c1df8f6";   // execnode/games/holdem.py (zkVM, nonce "a5")
