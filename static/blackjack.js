...
import { NadoDapp, rawToNado, nadoToRaw, _m, $, gate, canPay, orderCards, alertBar, notify, confirmingLabel, lsLoad as load, wireWallet, stickyInputs, renderWallet, renderScore, scoreBump, scoreSort, randId, loadQR, resolveAliases, disp, share, shareInvite , installModes , playModes} from "./nadodapp.js?v=eff4a9e1";
import { BankedGame } from "./bankedgame.js?v=88bc2959";
import { chainCards, cardHTML, injectCardCSS, bjTotal } from "./cards.js?v=bca9c6c9";
import { Practice } from "./practice.js?v=f261d882";      // free in-browser practice (play chips, no chain)

const CID = "e75071ecaabb27ee7058ae132d9e4bc9";
const REAP = 1200;
