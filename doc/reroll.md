...
`DEVICE_ATTEST_EK_SHORT_HEIGHT`, `DEVICE_ATTEST_EK_ROOTS_V2_HEIGHT`, `DEVICE_ATTEST_EK_PROVEN_HEIGHT`, `DEVICE_ATTEST_EK_READY_HEIGHT`, `TX_AT_MOST_ONCE_STRICT_HEIGHT`, `BOND_ATTEST_OPTIONAL_HEIGHT`,
`POOL_RETIRE_HEIGHT`,
