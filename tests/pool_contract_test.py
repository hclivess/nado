...
def t_free_game_full_lifecycle():
    ...
    # a few shots — free-actor log, ply-bound
    st.cursor = 101
    ...
    # settle: both agree p2 won. Zero pot -> zero payout, but the game must still close cleanly.
    call(A, "7", "agree", [G, 2])
...
if __name__ == "__main__":
    ...
    check("move bounds: enc>0, ply binding, 48-bit payload", t_move_bounds)
