...
TIER_BASE  = {1: 1, 2: 205, 3: 571, 4: 840, 5: 965, 6: 1002}  # first si of each tier's roster band
TIER_COUNT = {1: 204, 2: 366, 3: 269, 4: 125, 5: 37, 6: 7}    # animals in each tier (sum = 1008)
